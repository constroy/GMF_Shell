...
#line 131 "bison.tab.c" /* yacc.c:358  */
...
{
  "$end", "error", "$undefined", "STRING", "EOL", "'&'", "'<'", "'>'",
...
#line 1207 "bison.tab.c" /* yacc.c:1646  */
      default: break;
    }
